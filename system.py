...
ndyn_state = nstate - len(trunc_states)  # number of states/sites after truncation (e.g. number of dynamical states)
ndyn_phset = nstate - len(trunc_modes)  # number of sets of phonon modes after truncation
