...
from qclab.drivers.serial_driver import dynamics_serial_


def dynamics_parallel_slurm(algorithm, sim, seeds, ntasks, ncpus_per_task, sub_driver = dynamics_serial_, data = simulation.Data()):
