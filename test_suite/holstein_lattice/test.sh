...
python /home/akrotz/Research/pyMQC/main.py holstein_lattice_input_CFSSH_deterministic '{"address":"auto"}'
echo 'Testing Holstein lattice Coherent Fewest-Switches Surface Hopping Stochastic '
python /home/akrotz/Research/pyMQC/main.py holstein_lattice_input_CFSSH_stochastic '{"address":"auto"}'
